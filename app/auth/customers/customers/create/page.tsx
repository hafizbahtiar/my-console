...
export default function CreateCustomerPage() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (response.rows.length > 0) {
          const existing = response.rows[0] as unknown as Customer;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(t('customers_page.create_page.created_success'));
  ...
  // If user already has a customer, show message
  if (existingCustomer) {
    return (
      <div className="min-h-screen bg-background">
          ...
          <div className="px-4 sm:px-6 py-2 sm:py-3">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm">
              ...
              <span className="text-foreground font-medium truncate" suppressHydrationWarning>
                {t('customers_page.create_page.title')}
              </span>
            </nav>
          </div>
        </div>
        <div className="px-4 sm:px-6 py-8">
          <Card>
            <CardHeader>
              <CardTitle suppressHydrationWarning>{t('customers_page.create_page.already_exists_title')}</CardTitle>
              <CardDescription suppressHydrationWarning>
                {t('customers_page.create_page.already_exists_description')}
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="flex items-center justify-end gap-4">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p suppressHydrationWarning>{t('customers_page.create_page.cancel_tooltip')}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
                ...
                <Button type="submit" disabled={isSubmitting}>
                  {isSubmitting ? (
                    <>
                      ...
                      {t('customers_page.create_page.submitting')}
                    </>
                  ) : (
                    <>
              ...
              <TooltipContent>
                <p suppressHydrationWarning>
                  {isSubmitting ? t('customers_page.create_page.submitting_tooltip') : t('customers_page.create_page.create_tooltip')}
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle suppressHydrationWarning>
                {t('customers_page.create_page.unsaved_changes_title')}
              </AlertDialogTitle>
              <AlertDialogDescription suppressHydrationWarning>
                {t('customers_page.create_page.unsaved_changes_description')}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              ...
              >
                {t('customers_page.create_page.leave_without_saving')}
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
