      ...
      <CardHeader className="p-4 sm:p-6">
        <CardTitle className="flex items-center gap-2 text-lg sm:text-xl" suppressHydrationWarning>
          ...
          <span className="truncate">
            {t('blog_categories_page.table.title', { count: allCategories.length.toString() })}
          </span>
        </CardTitle>
                ...
                <TableRow>
                  <TableCell colSpan={7} className="text-center text-muted-foreground py-8 sm:py-12 px-4">
                    ...
                    <p className="text-sm sm:text-base font-medium" suppressHydrationWarning>
                      {t('blog_categories_page.table.no_categories')}
                    </p>
                    <p className="text-xs sm:text-sm mt-1" suppressHydrationWarning>
                      {t('blog_categories_page.table.no_categories_description')}
                    </p>
                  </TableCell>
                </TableRow>
              )}
